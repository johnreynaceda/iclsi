        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex space-x-2 items-center">
                        <span class="text-2xl font-bold text-white">ICLS</span>
                ...
                <div x-data="{
                    ...
                    <button @click="dropdownOpen=true"
                        ...
                        <span class="flex flex-col items-start flex-shrink-0 h-full ml-2 leading-none translate-y-px">
                            ...
                            <span
                                class="text-xs font-light text-green-500">{{ '@' . Str::ucfirst(auth()->user()->user_type) }}</span>
                        </span>
