...
<body class="font-sans text-gray-900 antialiased">
    <div
        class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gradient-to-br from-green-700 via-green-600 to-green-500">
        <div class="absolute flex  w-full left-0 bottom-0">
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" data-name="Layer 1"
                class="h-[30rem] z-50 relative" viewBox="0 0 1082 725">
                <defs>
                    <linearGradient id="b7709055-0dd4-48d6-ac10-5a758f15d1a1-17" x1="443.56" y1="792.13"
                        x2="443.56" y2="251.5" gradientUnits="userSpaceOnUse">
                        <stop offset="0" stop-color="gray" stop-opacity="0.25" />
                        <stop offset="0.54" stop-color="gray" stop-opacity="0.12" />
                        <stop offset="1" stop-color="gray" stop-opacity="0.1" />
                    </linearGradient>
                    <linearGradient id="f59ba046-7ebe-407e-be3d-c62856fc1078-18" x1="712" y1="788.54"
                        x2="712" y2="248.5" xlink:href="#b7709055-0dd4-48d6-ac10-5a758f15d1a1-17" />
                </defs>
                ...
                <g opacity="0.2">
                    ...
                    <path
                        ...
                        transform="translate(-59 -87.5)" fill="#f9a826" />
                    <path
                ...
                <ellipse cx="541" cy="694" rx="541" ry="31" fill="#f9a826"
                    opacity="0.1" />
                <ellipse cx="894.7" cy="676.64" rx="25.3" ry="4.87" fill="#f9a826" />
                ...
                <path
                    ...
                    transform="translate(-59 -87.5)" opacity="0.1" />
                <ellipse cx="313.7" cy="714.18" rx="33.8" ry="6.5" fill="#f9a826" />
                ...
                <path
                    ...
                    transform="translate(-59 -87.5)" fill="url(#b7709055-0dd4-48d6-ac10-5a758f15d1a1-17)" />
                <path
                ...
                <path
                    ...
                    transform="translate(-59 -87.5)" fill="url(#f59ba046-7ebe-407e-be3d-c62856fc1078-18)" />
                <path
                ...
                <path
                    ...
                    transform="translate(-59 -87.5)" fill="#f75842" />
                <circle cx="473" cy="60" r="7" fill="#f9a826" opacity="0.1" />
                <circle cx="520" cy="195" r="7" fill="#f9a826" opacity="0.1" />
                <circle cx="387" cy="67" r="7" fill="#f9a826" opacity="0.1" />
                <circle cx="172" cy="386" r="18" fill="#f9a826" opacity="0.1" />
                <circle cx="897" cy="100" r="7" fill="#f9a826" opacity="0.1" />
                <circle cx="905" cy="195" r="23" fill="#f9a826" opacity="0.1" />
                <circle cx="942" cy="130" r="7" fill="#f9a826" opacity="0.1" />
                <circle cx="880" cy="258" r="7" fill="#f9a826" opacity="0.1" />
                <circle cx="459" cy="116" r="7" fill="#f9a826" opacity="0.1" />
                <circle cx="197" cy="470" r="7" fill="#f9a826" opacity="0.1" />
                <circle cx="186" cy="310" r="7" fill="#f9a826" opacity="0.1" />
                <circle cx="570" cy="53" r="7" fill="#f9a826" opacity="0.1" />
                <circle cx="593" cy="116" r="7" fill="#f9a826" opacity="0.1" />
            </svg>
        </div>
        <div class="fixed">
            <img src="{{ asset('images/bg.jpg') }}" class="opacity-10" alt="">
        </div>
        <div class="text-center flex flex-col justify-center items-center">
            ...
            <h3
                class="text-xl relative leading-tight tracking-tight sm:text-2xl md:text-3xl lg:text-4xl mt-4  text-white font-bold">
                INFINITY CHILDREN LABORATORY SCHOOL INC.
            </h3>
        </div>

        <div
            class="w-full sm:max-w-md mt-6 px-8 py-8 z-50 relative bg-[#ffd83d] bg-opacity-80 shadow-md overflow-hidden sm:rounded-2xl">
            <div class="relative">
                {{ $slot }}
            </div>
        </div>
