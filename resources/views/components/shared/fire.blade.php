<svg enable-background="new 0 0 128 128" viewBox="0 0 128 128" {{ $attributes }} xmlns="http://www.w3.org/2000/svg"
    xmlns:xlink="http://www.w3.org/1999/xlink">
    <radialGradient id="a" cx="68.8839" cy="124.2963"
        gradientTransform="matrix(-1 -.00434301 -.00712592 1.6408 131.9857 -79.3452)" gradientUnits="userSpaceOnUse"
        r="70.587">
        <stop offset=".3144" stop-color="#ff9800" />
        <stop offset=".6616" stop-color="#ff6d00" />
        <stop offset=".9715" stop-color="#f44336" />
    </radialGradient>
    <radialGradient id="b" cx="64.9211" cy="54.0621"
        gradientTransform="matrix(-.0101 .9999 .7525 .00760378 26.1538 -11.2668)" gradientUnits="userSpaceOnUse"
        r="73.8599">
