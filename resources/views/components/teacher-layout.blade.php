                ...
                <div class="flex flex-col flex-grow pt-5 overflow-y-auto bg-green-600 ">
                    ...
                    <div class="flex flex-col flex-grow  mt-5">
                        <nav class="flex-1 space-y-1  ">
                            ...
                            <ul class="space-y-2">
                                <a class="{{ request()->routeIs('teacher.students') ? 'after:absolute after:right-0 after:top-0 after:h-full after:bg-active after:w-2 after:rounded-l-2xl' : ' ' }} inline-flex group items-center w-full px-8 py-1 hover:font-semibold hover:text-active mt-1 text-white transition duration-200 ease-in-out transform rounded-lg focus:shadow-outline   "
                                ...
                                <a class="{{ request()->routeIs('teacher.attendance') ? 'after:absolute after:right-0 after:top-0 after:h-full after:bg-active after:w-2 after:rounded-l-2xl' : ' ' }} inline-flex group items-center w-full px-8 py-1 hover:font-semibold hover:text-active mt-1 text-white transition duration-200 ease-in-out transform rounded-lg focus:shadow-outline   "
                                ...
                                <a class="{{ request()->routeIs('teacher.announcements') ? 'after:absolute after:right-0 after:top-0 after:h-full after:bg-active after:w-2 after:rounded-l-2xl' : ' ' }} inline-flex group items-center w-full px-8 py-1 hover:font-semibold hover:text-active mt-1 text-white transition duration-200 ease-in-out transform rounded-lg focus:shadow-outline   "
